 ...
 * Describe:
 */
public class NameDetailsPresenter {
    private Context mContext;
    private NameDetailsView mView;
    private final Gson mGson;

    public NameDetailsPresenter(Context mContext, NameDetailsView mView) {
...
//                .addParams("h", "15")
                ...
                .execute(new StringCallback() {
                    ...
                    public void onResponse(String response, int id) {
                        Log.e("mImageUri", "=========name===01======" + response);
    ...
    private void sendNo2Request(EightNumBean01.DataBean bean) {
        OkHttpUtils.post()
                .url(HttpConstants.NameDetails02)
                ...
                .execute(new StringCallback() {
                    ...
                    @Override
                    public void onResponse(String response, int id) {
                        Log.e("mImageUri", "=========name===02======" + response);
