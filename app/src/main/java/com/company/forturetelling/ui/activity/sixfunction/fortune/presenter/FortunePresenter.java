...
public class FortunePresenter {
    ...
    public FortunePresenter(Context mContext, FortuneView mView) {
...
//                            sendNo3Request(mBean02.getData().getOid());
                            ...
                            mView.updateFinish(mBean02.getData().getOid(), "今年运势",wechat_price,ali_price);
