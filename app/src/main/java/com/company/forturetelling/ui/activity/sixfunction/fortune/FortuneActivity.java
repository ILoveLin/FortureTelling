package com.company.forturetelling.ui.activity.sixfunction.fortune;
 ...
 * Describe:今年运势
 */
public class FortuneActivity extends BaseActivity implements FortuneView {
    ...
    public int getContentViewId() {
        return R.layout.activity_sixfuntion_fortune;
    }
    ...
    private void initView() {
        ...
        setPageStateView();
        mPresenter = new FortunePresenter(this, this);
