...
public class ResultNameDetalisActivity extends BaseActivity {
    ...
    private NameDetails03.DataBeanXX.RglmBean rglmBean;
        ...
        OkHttpUtils.post()
                ...
                .execute(new StringCallback() {
                    ...
                    public void onResponse(String response, int id) {
                        ...
                        Type type = new TypeToken<NameDetails03>() {
                        }.getType();
                        NameDetails03 mBean03 = mGson.fromJson(response, type);
    ...
    private void getSetSomeData(NameDetails03 mBean03) {
        NameDetails03.DataBeanXX.ReturnBean.UserBean.XingmingBean xingming = mBean03.getData().getReturnX().getUser().getXingming();

        NameDetails03.DataBeanXX.ReturnBean.UserBean userBean = mBean03.getData().getReturnX().getUser();
        username = xingming.getXing() + xingming.getMing();

        //阳历
        birthday = userBean.getNianling().getY() + "年" +
                userBean.getNianling().getM() + "月" +
                userBean.getNianling().getD() + "日  " +
                userBean.getNianling().getH() + "时";
        born = userBean.getLDate();
        ...
        sx = mBean03.getData().getReturnX().getInfo().getSxgx().getSx();
